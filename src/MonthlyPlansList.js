      ...
      >
        <Slider {...settings} className="slider-container">
          ...
          >
            ...
            <div
              style={{
                borderColor: actPrivate ? "#0B96B4" : "white",
                borderWidth: 1,
                borderStyle: "solid",
                padding: 20,
                borderRadius: 3,
            ...
            >
              ...
              >
                <div style={styles.price(actPrivate)}>$1k</div>
                <div style={styles.subtitle(actPrivate)}>monthly*</div>
              </div>
              <div
                style={{
              ...
              >
                <div style={styles.text(actPrivate)}>
                  <img
                    className="logo"
                    src={
                      actPrivate ? "/selectedTick.png" : "/unselectedTick.png"
                    }
                    alt="tick"
                    height={20}
                  />
                  <div style={styles.descText(actPrivate)}>
                ...
                <div style={styles.text(actPrivate)}>
                  ...
                  />
                  <div style={styles.descText(actPrivate)}>
                    Private Jet + First Class Flights
                  </div>{" "}
                  {/* Adjusted font size */}
                </div>
                <div style={styles.text(actPrivate)}>
          ...
          >
            <h1
              style={{
                color: actExecutive ? "#0B96B4" : "white",
                textAlign: "center",
                paddingTop: 0,
              }}
            >
            ...
            <div
              style={{
                borderColor: actExecutive ? "#0B96B4" : "white",
                borderWidth: 1,
                borderStyle: "solid",
                padding: 20,
                borderRadius: 3,
            ...
            >
              ...
              >
                <div style={styles.price(actExecutive)}>$4k</div>
                <div style={styles.subtitle(actExecutive)}>monthly*</div>
              </div>
              <div
                style={{
                  flexDirection: "column",
              ...
              >
                <div style={styles.text(actExecutive)}>
                  <img
                    className="logo"
                    src={
                      actExecutive ? "/selectedTick.png" : "/unselectedTick.png"
                    }
                    alt="tick"
                    height={20}
                  />
                  <div style={styles.descText(actExecutive)}>Private +</div>{" "}
                  {/* Adjusted font size */}
                </div>
                <div style={styles.text(actExecutive)}>
                  <img
                    ...
                    height={20}
                  />
                  <div style={styles.descText(actExecutive)}>
                    Real-time Support: 24/7/365
                  </div>{" "}
                  {/* Adjusted font size */}
                </div>
                <div style={styles.text(actExecutive)}>
...
export default MonthlyPlansList;
